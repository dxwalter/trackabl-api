...
import { EntrypointStatusMessages } from "../../src/Components/entrypoint/config/entrypoint-response-messages";
...
describe("Entrypoint Controller", () => {
  ...
  it("Create entrypoint data", () => {
    return request(app.getHttpServer())
      .post("/entrypoint")
      .send({
        heroBannerUrl:
          "https://res.cloudinary.com/dsvppsml4/image/upload/v1718264886/trackabl/entrypoint/gncgtxr5wmtnuh1r3zjx.png",
        mobileHeroBannerImage:
          "https://res.cloudinary.com/dsvppsml4/image/upload/v1718264886/trackabl/entrypoint/qybkexl5rgoc5ihvd5m7.png",
        benefitBannerUrl:
          "https://res.cloudinary.com/dsvppsml4/image/upload/v1718264869/trackabl/entrypoint/bdj6xda8o2kq59goso4a.png",
        mobileBenefitBanner: "",
      ...
      .expect(function (res) {
        ...
        if (res.body.message !== EntrypointStatusMessages.create.success) {
          throw new Error("Invalid message response.");
        }
